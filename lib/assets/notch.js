...
const icons = {
    // USB-C Port
    'usb-c': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="10" rx="5"></rect><line x1="8" y1="12" x2="16" y2="12"></line></svg>`,
...
ipcRenderer.on('trigger-notch', async (event, {
    ...
    let iconSvg = icons.check; // Default to checkmark
