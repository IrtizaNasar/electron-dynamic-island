...
- [Usage](#usage)
    - [1. Initialize](#1-initialize-in-main-process)
    - [2. Trigger Notifications](#2-trigger-notifications)
    - [3. Best Practice: Check Support](#3-best-practice-check-support)
    - [4. Advanced Usage](#4-advanced-usage)
    - [5. Animations](#5-animations)
    - [6. Customization](#6-customization)
    - [7. Built-in Icons](#7-built-in-icons)
